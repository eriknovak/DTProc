...
const production = {
    elasticsearch: {
        node: process.env.PROD_ELASTICSEARCH_NODE || "http://localhost:9200/"
    },
    kafka: {
...
const development = {
    elasticsearch: {
        node: process.env.DEV_ELASTICSEARCH_NODE || "http://localhost:9200/"
    },
    kafka: {
...
const test = {
    elasticsearch: {
        node: process.env.TEST_ELASTICSEARCH_NODE || "http://localhost:9200/"
    },
    kafka: {
